 ...
 * @property $role Role
 */
class Admins extends AdminsIdentity
{
...
//------------------------------------------------------------------------------------------------//
    ...
    {
        return static::findOne(['username' => $username, 'status' => Admins::STATUS_ACTIVE]);
    }  
    ...
    {
        return static::findOne(['email' => $email, 'status' => Admins::STATUS_ACTIVE]);
    } 
    ...
    public static function findByAccountActivationToken($token)
    {
        return static::findOne([
            ...
            'status' => Admins::STATUS_NOT_ACTIVE,
        ]);
    }
